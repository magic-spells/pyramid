...
export type McpErrorCode =
  ...
  | 'permission_denied' | 'validation_failed' | 'rate_limited'
  | 'conflict'
...
export interface WorkflowStage { id: string; key: string; name: string; position: string; category?: string; }
export interface WorkflowStatus { id: string; key: string; name: string; stage_id: string; position: string; category?: string; }
export interface WorkflowMember { id: string; display_name: string; email: string; role: string; }
export interface CustomFieldDef { id: string; key: string; name: string; field_type: string; options?: string[]; }
...
export interface UserStub { id: string; display_name: string; }

export interface TaskSummary {
  id: string; key: string; title: string; description: string | null;
  status: { id: string; name: string };
  stage: { id: string; name: string };
  owner: UserStub | null; reporter: UserStub | null;
  labels: string[]; archived: boolean; updated_at: string;
}
...
export interface TaskReference {
  ...
  external_status: string | null; external_sub_id: string | null;
}
...
export interface CustomFieldValue { field: string; value: unknown; }
